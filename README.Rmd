...
ggplot() + annotation_custom(grid::rasterGrob(
  magick::image_read(here("data-raw","coleus1b.JPG")),
  width=unit(1,"npc"),
  height=unit(1,"npc")),
  -Inf, Inf, -Inf, Inf)
nic_palette("coleusb_3", 3)
ggplot() + annotation_custom(grid::rasterGrob(
  magick::image_read(here("data-raw","wishbone.jpg")),
  width=unit(1,"npc"),
  height=unit(1,"npc")),
  -Inf, Inf, -Inf, Inf)
nic_palette("wishbone_3", 3)
ggplot() + annotation_custom(grid::rasterGrob(
  magick::image_read(here("data-raw","buttercup.jpeg")),
  width=unit(1,"npc"),
  height=unit(1,"npc")),
  -Inf, Inf, -Inf, Inf)
...
ggplot() + annotation_custom(grid::rasterGrob(
  magick::image_read(here("data-raw","moss_rose_4.jpeg")),
  width=unit(1,"npc"),
  height=unit(1,"npc")),
  -Inf, Inf, -Inf, Inf)
...
ggplot() + annotation_custom(grid::rasterGrob(
  magick::image_read(here("data-raw","squarestem.jpeg")),
  width=unit(1,"npc"),
  height=unit(1,"npc")),
  -Inf, Inf, -Inf, Inf)
nic_palette("squarestem_5", 5)
ggplot() + annotation_custom(grid::rasterGrob(
  magick::image_read(here("data-raw","papaya.jpeg")),
  width=unit(1,"npc"),
  height=unit(1,"npc")),
  -Inf, Inf, -Inf, Inf)
